...
// var favShow = "elementary";
// for (var letter in favShow) {
// 	console.log(favShow[letter]);
// }

// //create a for in loop for your favourite food
// //then, can you count each vowel that occurs in that food?

var favFood = "mashed potatoes (the e is for excellent)"
var vowelCount = 0

console.log(favFood.length);
var ffl = favFood[letter];

for(var letter in favFood) {
	if(ffl == "a" ||ffl == "e" ||ffl == "i" || ffl == "o" || ffl == "u") {
		console.log(ffl)
	} else {
			vowelCount++
	}
